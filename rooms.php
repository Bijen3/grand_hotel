                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="mb-2">
                                    <input type="checkbox" id="f1" class="form-check-label shadow-none me-1">
                                    <label class="form-label" for="f1">Facility one</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f2" class="form-check-label shadow-none me-1">
                                    <label class="form-label" for="f2">Facility two</label>
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f3" class="form-check-label shadow-none me-1">
            ...
            <div class="col-lg-12 col-md-12 px-5">
                ...
                while ($room_data = mysqli_fetch_assoc($room_res)) {
                    ...
                    if (isset($_SESSION['user'])) {
                        $book_btn = "<a href='book_now.php?room_id=$room_data[id]' class='btn btn-sm w-100 text-white custom-bg shadow-none mb-2'>Book Now</a>";
                    } else {
                        $book_btn = "<a href='signin.php' class='btn btn-sm w-100 btn-outline-dark shadow-none mb-2'>Please Login to Book</a>";
                    }
