<?php
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>
                        ...
                        <span class='badge rounded-pill bg-light text-dark'><br>
    ...
    if(isset($_POST['edit_room'])){
        ...
        $del_features = delete_item("DELETE FROM `room_features` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
        $del_facilities = delete_item("DELETE FROM `room_facilities` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
    ...
    if(isset($_POST['remove_room'])){
        ...
        $res2 = delete_item("DELETE FROM `room_images` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
        $res3 = delete_item("DELETE FROM `room_features` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
        $res4 = delete_item("DELETE FROM `room_facilities` WHERE `room_id`=?", [$frm_data['room_id']], 'i');
